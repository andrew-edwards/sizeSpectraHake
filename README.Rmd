...
[![Codecov test coverage](https://codecov.io/gh/andrew-edwards/sizeSpectraHake/branch/main/graph/badge.svg)](https://app.codecov.io/gh/andrew-edwards/sizeSpectraHake?branch=main)
<!-- badges: end -->

The goal of sizeSpectraHake is to analyse the hake length data. Won't work
for others as data not included in package.
