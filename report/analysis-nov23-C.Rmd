...
# TODO For now just getting working for id_with_B, can put the options into a
# larger function. So we have 10-mm counts for same id. So write a wrapper that
# does these inputs depending on whether 10-mm exists. TODO. For now just
# getting it working.

# TODO Will want to use counts_per_bin_1_mm_one_year for the sets without 10-mm bins.
