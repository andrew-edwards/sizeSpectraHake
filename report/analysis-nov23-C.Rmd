...
# Rest of this chunk is about to (next commit) going into:
...
# NEEDED to work out xmin [could incorporate some into determine_xmin, though
# still want to reuse or recalculate this later]
...
call new function that loops over hauls

then replace any 10-mm hauls that have been apportioned

    # somewhereAppend new values to those for previous hauls (done in earlier iterations
    # of this loop).
