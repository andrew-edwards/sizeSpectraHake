...
#make_hist_10_mm <- make_hist(counts_per_bin_10_mm_one_year_apportioned,
# bin_width = 10)    # TODO adapt function to use the
                                        # bin_width specified maybe. And get an
...
TODO that 10-mm figure ignores the apportioning, maybe just keep the plot as
that for now.
