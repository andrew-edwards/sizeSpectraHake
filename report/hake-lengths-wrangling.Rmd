...
**Saving this as `hake-length-wrangling-***.pdf` with the figuring out of two sets in a haul, then simplifying down
...
Going to save this pdf in commit after `**7dd0fe3`, and call it
`hake-lengths-wrangling-***.pdf`. Then going to change
